...
;(async () => {
  try {
    const voteContractAddress = await sdk.deployer.deployVote({
      ...
      voting_token_address: '0x103ea38d8B31CDfa07BAC2CB3517d07a4822aB61',
      ...
      // The minimum % of the total supply that need to vote for the proposal to be valid after the time for the proposal has ended
